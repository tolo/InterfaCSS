...
final class PropertyRepository {
  ...
  /**
   * Registers a custom property. If an identical property already exists, and if ´replaceExisting´ is ´false´, the specified property will not be registered,
   * and the existing property will instead be returned by this method. 
   */
