...
extension PropertyRepository {
  ...
  func _register(_ name: String, in clazz: AnyClass, type: PropertyType, enums enumValueMapping: AnyPropertyEnumValueMappingType? = nil) -> Property? {
    guard let runtimeProperty = RuntimeIntrospectionUtils.runtimeProperty(withName: name, in: clazz, lowercasedNames: true) else {
      logError(.properties, "Cannot register '\(name)' in '\(clazz)'")
      return nil
    }
    return register(Property(runtimeProperty: runtimeProperty, type: type, enumValueMapping: enumValueMapping), in: clazz)
  }
  ...
  func _register(_ name: String, in clazz: AnyClass, type: PropertyType, selector: Foundation.Selector, params parameterTransformers: [PropertyParameterTransformer]) -> Property {
    return register(Property(withName: name, in: clazz, type: type, selector: selector, enumValueMapping: nil, parameterTransformers: parameterTransformers), in: clazz)
  }
  ...
  func _register<TargetType, ValueType>(_ name: String, in clazz: TargetType.Type, type: PropertyType, typedSetter: @escaping TypedNeverFailingPropertySetterBlock<TargetType, ValueType>) -> Property {
    return register(Property(withName: name, in: clazz as! AnyClass, type: type, setterBlock: typedSetter), in: clazz as! AnyClass)
  }
  ...
  func registerDefaultUIKitProperties() {
    let controlStateParametersValues: [String: UIControl.State] = [
      "normal": .normal, "focused": .focused, "highlighted": .highlighted,
      "selected": .selected, "disabled": .disabled]
    let controlStateMapping = PropertyBitMaskEnumValueMapping(enumValues: controlStateParametersValues, enumBaseName: "UIControlState", defaultValue: .normal)
    ...
    let controlStateTransformer: PropertyParameterTransformer = { property, parameterStringValue in
      return controlStateMapping.enumValue(from: parameterStringValue)
    }
    let barMetricsTransformer: PropertyParameterTransformer = { property, parameterStringValue in
      return barMetricsMapping.enumValue(from: parameterStringValue)
    }
    let barPositionTransformer: PropertyParameterTransformer = { property, parameterStringValue in
      return barPositionMapping.enumValue(from: parameterStringValue)
    }
    let integerTransformer: PropertyParameterTransformer = { property, parameterStringValue in
      return Int(parameterStringValue) ?? 0
    }
    let segmentTypeTransformer: PropertyParameterTransformer = { property, parameterStringValue in
      return segmentTypeMapping.enumValue(from: parameterStringValue)
    }
    let searchBarIconTransformer: PropertyParameterTransformer = { property, parameterStringValue in
      return searchBarIconMapping.enumValue(from: parameterStringValue)
    }
    ...
    //* UIButton *//
    clazz = UIButton.self
    _register("attributedTitle", in: clazz, type: .string, selector: #selector(UIButton.setAttributedTitle(_:for:)), params: [controlStateTransformer])
    _register("backgroundImage", in: clazz, type: .image, selector: #selector(UIButton.setBackgroundImage(_:for:)), params: [controlStateTransformer])
    _register("image", in: clazz, type: .image, selector: #selector(UIButton.setImage(_:for:)), params: [controlStateTransformer])
    _register("title", in: clazz, type: .string, selector: #selector(UIButton.setTitle(_:for:)), params: [controlStateTransformer])
    _register("titleColor", in: clazz, type: .color, selector: #selector(UIButton.setTitleColor(_:for:)), params: [controlStateTransformer])
    _register("titleShadowColor", in: clazz, type: .color, selector: #selector(UIButton.setTitleShadowColor(_:for:)), params: [controlStateTransformer])
    ...
    _register("backgroundImage", in: clazz, type: .image, selector: #selector(UISegmentedControl.setBackgroundImage(_:for:barMetrics:)), params: [controlStateTransformer, barMetricsTransformer])
    _register("contentPositionAdjustment", in: clazz, type: .offset, selector: #selector(UISegmentedControl.setContentPositionAdjustment(_:forSegmentType:barMetrics:)), params: [segmentTypeTransformer, barMetricsTransformer])
    ...
    _register("dividerImage", in: clazz, type: .image, selector: #selector(UISegmentedControl.setDividerImage(_:forLeftSegmentState:rightSegmentState:barMetrics:)), params: [
      controlStateTransformer, controlStateTransformer, barMetricsTransformer
    ])
    ...
    _register("titleTextAttributes", in: clazz, type: .textAttributes, selector: #selector(UISegmentedControl.setTitleTextAttributes(_:for:)), params: [controlStateTransformer])
    ...
    //* UISlider *//
    clazz = UISlider.self
    _register("maximumTrackImage", in: clazz, type: .image, selector: #selector(UISlider.setMaximumTrackImage(_:for:)), params: [controlStateTransformer])
    _register("minimumTrackImage", in: clazz, type: .image, selector: #selector(UISlider.setMinimumTrackImage(_:for:)), params: [controlStateTransformer])
    _register("thumbImage", in: clazz, type: .image, selector: #selector(UISlider.setThumbImage(_:for:)), params: [controlStateTransformer])
    
    //* UIStepper *//
    clazz = UIStepper.self
    _register("backgroundImage", in: clazz, type: .image, selector: #selector(UIStepper.setBackgroundImage(_:for:)), params: [controlStateTransformer])
    _register("decrementImage", in: clazz, type: .image, selector: #selector(UIStepper.setDecrementImage(_:for:)), params: [controlStateTransformer])
    _register("dividerImage", in: clazz, type: .image, selector: #selector(UIStepper.setDividerImage(_:forLeftSegmentState:rightSegmentState:)), params: [controlStateTransformer, controlStateTransformer])
    _register("incrementImage", in: clazz, type: .image, selector: #selector(UIStepper.setIncrementImage(_:for:)), params: [controlStateTransformer])
    #endif
    ...
    _register("titleTextAttributes", in: clazz, type: .textAttributes, selector: #selector(UIBarItem.setTitleTextAttributes(_:for:)), params: [controlStateTransformer])
    
    //* UIBarButtonItem *//
    clazz = UIBarButtonItem.self
    //setBackgroundImage:forState:style:barMetrics:
    _register("backButtonBackgroundImage", in: clazz, type: .image, selector: #selector(UIBarButtonItem.setBackButtonBackgroundImage(_:for:barMetrics:)), params: [controlStateTransformer, barMetricsTransformer])
    ...
    _register("backgroundImage", in: clazz, type: .image, selector: #selector(UIBarButtonItem.setBackgroundImage(_:for:barMetrics:)), params: [controlStateTransformer, barMetricsTransformer])
    ...
    #endif
    _register("imageForSearchBarIcon", in: clazz, type: .image, selector: #selector(UISearchBar.setImage(_:for:state:)), params: [searchBarIconTransformer, controlStateTransformer])
    ...
    _register("scopeBarButtonBackgroundImage", in: clazz, type: .image, selector: #selector(UISearchBar.setScopeBarButtonBackgroundImage(_:for:)), params: [controlStateTransformer])
    _register("scopeBarButtonDividerImage", in: clazz, type: .image, selector: #selector(UISearchBar.setScopeBarButtonDividerImage(_:forLeftSegmentState:rightSegmentState:)), params: [controlStateTransformer, controlStateTransformer])
    #if os(iOS)
    _register("scopeBarButtonTitleTextAttributes", in: clazz, type: .textAttributes, selector: #selector(UISearchBar.setScopeBarButtonTitleTextAttributes(_:for:)), params: [controlStateTransformer])
    #endif
    ...
    _register("searchFieldBackgroundImage", in: clazz, type: .image, selector: #selector(UISearchBar.setSearchFieldBackgroundImage(_:for:)), params: [controlStateTransformer])
