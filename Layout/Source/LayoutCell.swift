 ...
 * LayoutCell
 */
public protocol LayoutCell: AnyObject {
...
public extension LayoutCell where Self: UIView {
  ...
  public func configureLayout(withViewBuilder viewBuilder: ViewBuilder, didLoadCallback: LayoutViewDidLoadCallback? = nil) {
  ...
  public func calculateSizeThatFits(_ size: CGSize) -> CGSize {
