...
public final class AbstractViewTreeNode { // TODO: Rename to AbstractLayoutElement
  ...
  @discardableResult private func visitAbstractViewTree(parentNode: AbstractViewTreeNode?, parentView: AnyObject?, visitor: AbstractViewTreeVisitor) -> Any? {
  ...
  public func visitViewTree(with viewBuilder: ViewBuilder, fileOwner: AnyObject? = nil, visitor: ViewTreeVisitor) -> UIView? {
    return visitAbstractViewTree() { (node, parentNode, parentView) in
      guard let viewObject = node.createElement(viewBuilder: viewBuilder, parentView: parentView, fileOwner: fileOwner) else {
        return nil
      }
  ...
  public func createElement(viewBuilder: ViewBuilder, parentView: AnyObject?, fileOwner: AnyObject?) -> UIResponder? {
