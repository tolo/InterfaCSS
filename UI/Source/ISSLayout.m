...
- (CGFloat) resolveForElement:(UIView*)element withRelativeElement:(ISSElementStylingProxy*)relativeElementDetails layoutGuideInsets:(UIEdgeInsets)layoutGuideInsets didResolve:(BOOL*)didResolve {
...
- (CGFloat) resolveValue:(ISSLayoutAttributeValue*)attributeValue forView:(UIView*)view elementMappings:(NSDictionary*)elementMappings layoutGuideInsets:(UIEdgeInsets)layoutGuideInsets didResolve:(BOOL*)didResolve {
    ISSElementStylingProxy* relativeElementDetails = attributeValue.relativeElementId ? elementMappings[attributeValue.relativeElementId] : nil;
